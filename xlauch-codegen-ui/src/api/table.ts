...
export const useTableImportSubmitApi = (projectId: string, datasourceId: string, tableNameList: string) => {
	return service.post('/gen/table/import/' + projectId + "/" + datasourceId, tableNameList)
}
